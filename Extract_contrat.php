 ...
 * Reçoit image/PDF en base64, appelle extract_contrat.py, retourne JSON.
 */
...
$pythonScript = __DIR__ . '/extract_contrat.py';
...
$zone        = preg_replace('/[^a-zA-Z\-\s]/', '', (string) ($body['zone'] ?? 'Tunisie'));
...
$cmd       = "$argBin $argScript $argFile $argZone 2>&1";
